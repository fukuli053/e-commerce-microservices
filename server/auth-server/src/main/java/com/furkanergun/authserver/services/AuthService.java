...
public class AuthService {
    ...
    public AuthResponse register(AuthRequest authRequest) {
        ...
        UserVO userVO = restTemplate.postForObject("http://user-service:3335/users", authRequest, UserVO.class);
