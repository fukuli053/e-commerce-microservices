...
export const TAB_CONFIG = [
    {index: 0, label: 'ERKEK', color: '#ee5f73', mapKey: "men"},
    {index: 1, label: 'KADIN', color: '#fb56c1', mapKey: "women"},
    {index: 2, label: 'ÇOCUK', color: '#f26a10', mapKey: "boys"},
    {index: 3, label: 'AKSESUAR', color: '#0db7af', mapKey: "essentials"},
    {index: 4, label: 'EV & YAŞAM', color: '#f2c210', mapKey: "homeAndLiving"},
];
...
export const MONTHS = ['Ocak', 'Şubat', 'Mart', 'Nisan', 'Mayıs', 'Haziran', 'Temmuz',
