...
const TopCategoriesAndBrands = () => {
    ...
    return (
        <>
            {renderCategoryAndBrandsList("En Çok Tercih Edilen Markalar", homeAPIData.data.brands, queryType.brand)}
            {renderCategoryAndBrandsList("En Çok Tercih Edilen Kategoriler", homeAPIData.data.apparels, queryType.apparel)}
        </>
    )
};
