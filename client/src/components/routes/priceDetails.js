...
function PriceDetails() {
    ...
    return (
        <Grid container justify="center">
            ...
            {renderGridData("Sepet Toplamı", `${cartTotal} ₺`, {...paymentStyles, paddingTop: 10})}
            {renderGridData("Kargo", `${deliveryCharges} ₺`, {...paymentStyles, paddingTop: 10})}

            <Grid item container sm={10} style={{paddingTop: 17}}>
                <Divider style={{width: "100%", height: 1}}/>
            </Grid>

            {renderGridData("Sipariş Toplamı", `${cartTotal + deliveryCharges} ₺`,
