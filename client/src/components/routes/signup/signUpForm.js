        ...
        return (
            <Grid container>
                <form onSubmit={this.handleSubmit}
                    ...
                    {renderFormTextField("Kullanıcı Adı", "username", <AccountCircle/>, "text")}
                    {renderFormTextField("E-Posta", "email", <EmailIcon/>, "email")}
                    {renderFormTextField("Şifre", "password", <LockIcon/>, "password")}
                    {renderFormTextField("Şifre Tekrar", "confirmPassword", <LockIcon/>, "password")}
