...
const shippingOptionsData = {
    "free": {
        ...
        transitLabel: "Teslimat Süresi: 3-6 iş günü",
        estimatedDays: [3, 6]
    },
    "premium": {
        price: `${deliveryPrices.premium}.00 ₺`,
        label: "Premium",
        transitLabel: "Teslimat Süresi: 2-3 iş günü",
        estimatedDays: [2, 3]
    },
    "express": {
        price: `${deliveryPrices.express}.00 ₺`,
        label: "Express",
        transitLabel: "Teslimat Süresi: 1-2 iş günü",
        estimatedDays: [1, 2]
    },
}
            ...
            <Grid item container xs={12} sm={12} style={{width: "inherit", paddingTop: 20}}>
                ...
                <Grid item xs={7}>
                    ...
                    <Grid item style={{fontWeight: "bold"}}>
                        {`Teslimat tarihi ${getEstimatedDeliveryDate(estimatedDays)}`}
                    </Grid>
                </Grid>
